 ...
 *search	在数组objects中搜索元素element
 sortingByChoose	使用选择排序法，对数组intArray进行排序
 sortingByInsert	使用插入排序法，对数组intArray进行排序
 sortingByBubbling	使用冒泡排序法，对数组intArray进行排序
 sortingByFastRecursion	使用递归快排法，对数组intArray进行排序
 sortingByFastStack	使用栈快排法，对数组intArray进行排序
 upsideDown	将数组颠倒
